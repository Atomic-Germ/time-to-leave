...
describe('Preload.js', function()
{
    ...
    beforeEach(function()
    {
        ...
        // Read the preload.js file and modify it to work in our test environment
        const preloadPath = join(__dirname, '../../js/preload.js');
        const originalCode = readFileSync(preloadPath, 'utf8');

        // Replace the problematic import.meta.url line with a simple assignment
        preloadCode = originalCode.replace(
            'global.require = createRequire(import.meta.url);',
            'global.require = createRequire("file:///test/preload.js");'
        );
    ...
    describe('Module Execution', function()
    {
        ...
        it('should set up global.require', function()
        {
            // Execute the preload script
            vm.runInContext(preloadCode, context);

            // Verify global.require was set
            assert.strictEqual(typeof context.global.require, 'function', 'Should set global.require to a function');
        });
    });
