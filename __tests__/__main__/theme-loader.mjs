...
describe('Theme System', function()
{
    describe('Theme Options', function()
    {
        it('should have defined theme options', function()
        {
            ...
            assert.strictEqual(expectedThemes.length, 3, 'Should have exactly 3 theme options');
    ...
    {
        it('should have consistent theme references in user preferences', async function()
        {
            const fs = await import('fs');
